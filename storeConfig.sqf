...
[
	// Handguns
	["PM 9mm", "hgun_Pistol_01_F", 75],
	["P07", "hgun_P07_F", 100],
    ["P07 (Khaki)", "hgun_P07_khk_F", 100, "noDLC"],
	["P07 (Black)", "hgun_P07_blk_F", 100, "noDLC"],
	["Rook-40", "hgun_Rook40_F", 150],
	["ACP-C2", "hgun_ACPC2_F", 75],
	["Zubr", "hgun_Pistol_heavy_02_F", 200],
	["4-Five", "hgun_Pistol_heavy_01_F", 200],
	["4-Five (Green)", "hgun_Pistol_heavy_01_green_F", 200, "noDLC"]

];

smgArray = compileFinal str
[
	["PDW2000", "hgun_PDW2000_F", 250],
    ["Protector", "SMG_05_F", 250],
	["Sting", "SMG_02_F", 250],
	["Vermin", "SMG_01_F", 250],
...
[
	...
	// Assault Rifles
	["Mk20C", "arifle_Mk20C_plain_F", 200],
	["Mk20C (Camo)", "arifle_Mk20C_F", 200],
	["Mk20", "arifle_Mk20_plain_F", 250],
	["Mk20 (Camo)", "arifle_Mk20_F", 250],
	["Mk20 GL", "arifle_Mk20_GL_plain_F", 300],
	["Mk20 GL (Camo)", "arifle_Mk20_GL_F", 300],

	["TRG-20 Carbine", "arifle_TRG20_F", 200],
	["TRG-21", "arifle_TRG21_F", 250],
	["TRG-21 GL", "arifle_TRG21_GL_F", 300],

	["SPAR-16 (Black)", "arifle_SPAR_01_blk_F", 200],
	["SPAR-16 (Khaki)", "arifle_SPAR_01_khk_F", 200],
	["SPAR-16 (Sand)", "arifle_SPAR_01_snd_F", 200],
	["SPAR-16 GL (Black)", "arifle_SPAR_01_GL_blk_F", 300],
	["SPAR-16 GL (Khaki)", "arifle_SPAR_01_GL_khk_F", 300],
	["SPAR-16 GL (Sand)", "arifle_SPAR_01_GL_snd_F", 300],

	["CAR-95 (Black)", "arifle_CTAR_blk_F", 200],
	["CAR-95 (Green Hex)", "arifle_CTAR_ghex_F", 200],
	["CAR-95 (Hex)", "arifle_CTAR_hex_F", 200],
	["CAR-95 GL (Black)", "arifle_CTAR_GL_blk_F", 300],
	["CAR-95 GL (Green Hex)", "arifle_CTAR_GL_ghex_F", 300],
	["CAR-95 GL (Hex)", "arifle_CTAR_GL_hex_F", 300],

	["Katiba Carbine", "arifle_Katiba_C_F", 300],
	["Katiba ", "arifle_Katiba_F", 325],
	["Katiba GL ", "arifle_Katiba_GL_F", 350],

	["MXC (Black)", "arifle_MXC_Black_F", 300],
	["MXC (Khaki)", "arifle_MXC_khk_F", 300, "noDLC"],
	["MXC (Sand)", "arifle_MXC_F", 300],
	["MX (Black)", "arifle_MX_Black_F", 325],
	["MX (Khaki)", "arifle_MX_khk_F", 325, "noDLC"],
	["MX (Sand)", "arifle_MX_F", 325],
	["MX 3GL (Black)", "arifle_MX_GL_Black_F", 350],
	["MX 3GL (Khaki)", "arifle_MX_GL_khk_F", 350, "noDLC"],
	["MX 3GL (Sand)", "arifle_MX_GL_F", 350],
	...
	["Promet SG 6.5", "arifle_MSBS65_UBS_F", 750],
	["Promet SG 6.5 (Black)", "arifle_MSBS65_UBS_black_F", 750],
	["Promet SG 6.5 (Camo)", "arifle_MSBS65_UBS_camo_F", 750],
	["Promet SG 6.5 (Sand)", "arifle_MSBS65_UBS_sand_F", 750],

	["AKS-74U", "arifle_AKS_F", 200],
	["AKM", "arifle_AKM_F", 250],
	["AKU-12 (Black)", "arifle_AK12U_F", 300],
	["AKU-12 (Lush)", "arifle_AK12U_lush_F", 300],
	["AKU-12 (Arid)", "arifle_AK12U_arid_F", 300],
	["AK-12 (Black)", "arifle_AK12_F", 300],
	["AK-12 (Lush)", "arifle_AK12_lush_F", 300, "noDLC"],
	["AK-12 (Arid)", "arifle_AK12_arid_F", 300, "noDLC"],
	["AK-12 GL (Black)", "arifle_AK12_GL_F", 350],
	["AK-12 GL (Lush)", "arifle_AK12_GL_lush_F", 350, "noDLC"],
	["AK-12 GL (Arid)", "arifle_AK12_GL_arid_F", 350, "noDLC"],

	["Kozlice 12G", "sgun_HunterShotgun_01_F", 300],
	["Kozlice 12G (Sawed Off)", "sgun_HunterShotgun_01_sawedoff_F", 150],

	["Type 115 Stealth (Black)", "arifle_ARX_blk_F", 2000],
    ["Type 115 Stealth (Green Hex)", "arifle_ARX_ghex_F", 2000],
    ["Type 115 Stealth (Hex)", "arifle_ARX_hex_F", 2000],

	// Marksman Rifles
	["MXM", "arifle_MXM_F", 400],
    ["MXM (Khaki)", "arifle_MXM_khk_F", 400, "noDLC"],
	["MXM (Black)", "arifle_MXM_Black_F", 450],
	...
	["Rahim", "srifle_DMR_01_F", 600],

	["Mk18 ABR", "srifle_EBR_F", 700],

    ["SPAR-17 EMR (Black)", "arifle_SPAR_03_blk_F", 700],
    ["SPAR-17 EMR (Khaki)", "arifle_SPAR_03_khk_F", 700],
    ["SPAR-17 EMR (Sand)", "arifle_SPAR_03_snd_F", 700],

	["Mk14 (Classic)", "srifle_DMR_06_hunter_F", 600],
	["Mk14 (Camo)", "srifle_DMR_06_camo_F", 700],
	["Mk14 (Olive)", "srifle_DMR_06_olive_F", 700],

	["Mk-I EMR (Black)", "srifle_DMR_03_F", 700],
	["Mk-I EMR (Camo)", "srifle_DMR_03_multicam_F", 700],
	["Mk-I EMR (Khaki)", "srifle_DMR_03_khaki_F", 700],
	["Mk-I EMR (Sand)", "srifle_DMR_03_tan_F", 700],
	["Mk-I EMR (Woodland)", "srifle_DMR_03_woodland_F", 700],

	["MAR-10 (Black)", "srifle_DMR_02_F", 4500],
	["MAR-10 (Camo)", "srifle_DMR_02_camo_F", 4500],
	["MAR-10 (Sand)", "srifle_DMR_02_sniper_F", 4500],

	["Cyrus (Black)", "srifle_DMR_05_blk_F", 4500],
	["Cyrus (Hex)", "srifle_DMR_05_hex_F", 4500],
	["Cyrus (Tan)", "srifle_DMR_05_tan_f", 4500],

	["ASP-1 Kir (Black)", "srifle_DMR_04_F", 1000],
	["ASP-1 Kir (Tan)", "srifle_DMR_04_tan_F", 1000],

	["M320 LRR", "srifle_LRR_F", 9000],
	["M320 LRR (Arid)", "srifle_LRR_camo_F", 9000],
    ["M320 LRR (Tropic)", "srifle_LRR_tna_F", 9000, "noDLC"],

	["GM6 Lynx", "srifle_GM6_F", 10000],
	["GM6 Lynx (Arid Hex)", "srifle_GM6_camo_F", 10000],
    ["GM6 Lynx (Tropic Hex)", "srifle_GM6_ghex_F", 10000, "noDLC"]
];

lmgArray = compileFinal str
[
	["SPAR-16S (Black)", "arifle_SPAR_02_blk_F", 400],
    ["SPAR-16S (Khaki)", "arifle_SPAR_02_khk_F", 400],
    ["SPAR-16S (Sand)", "arifle_SPAR_02_snd_F", 400],

	["LIM-85 (Black)", "LMG_03_F", 1000],

	["CAR-95-1 (Black)", "arifle_CTARS_blk_F", 400],
	["CAR-95-1 (Green Hex)", "arifle_CTARS_ghex_F", 400],
	["CAR-95-1 (Hex)", "arifle_CTARS_hex_F", 400],

	["MX SW (Black)", "arifle_MX_SW_Black_F", 400],
	["MX SW (Khaki)", "arifle_MX_SW_khk_F", 400, "noDLC"],
	["MX SW (Sand)", "arifle_MX_SW_F", 400],

	["Mk200", "LMG_Mk200_F", 1000],
	["Mk200 (Black)", "LMG_Mk200_black_F", 1000, "noDLC"],

	["Zafir", "LMG_Zafir_F", 1500],
    ...
    ["Navid (Tan)", "MMG_01_tan_F", 7500],
	["Navid (Hex)", "MMG_01_hex_F", 7500],

	["SPMG (Black)", "MMG_02_black_F", 7500],
	["SPMG (Sand)", "MMG_02_sand_F", 7500],
	["SPMG (MTP)", "MMG_02_camo_F", 7500]
];

launcherArray = compileFinal str
[
    ["RPG-7", "launch_RPG7_F", 750],
	["RPG-42 Alamut (Arid Hex)", "launch_RPG32_F", 1000],
    ["RPG-42 Alamut (Tropic Hex)", "launch_RPG32_ghex_F", 1000, "noDLC"],
    ...
    ["Titan MPRL Compact (Tropic Hex)", "launch_O_Titan_short_ghex_F", 2000, "noDLC"],
	["Titan MPRL AA (Sand)", "launch_Titan_F", 2000],
	["Titan MPRL AA (Olive)", "launch_I_Titan_olive_F", 2000, "noDLC"],
	["Titan MPRL AA (Tropic)", "launch_B_Titan_tna_F", 2000, "noDLC"],
	["Titan MPRL AA (Digi)", "launch_I_Titan_F", 2000],
	["Titan MPRL AA (Geometric)", "launch_I_Titan_eaf_F", 2000, "noDLC"],
	["Titan MPRL AA (Arid Hex)", "launch_O_Titan_F", 2000],
    ["Titan MPRL AA (Tropic Hex)", "launch_O_Titan_ghex_F", 2000, "noDLC"]
];
...
[
	...
	["M2 HMG", "B_G_HMG_02_F", 2000], //NATO
	["M2 HMG (Raised)", "B_G_HMG_02_high_F", 2000], //NATO
	["M2 HMG", "I_G_HMG_02_F", 2000], //Green
	["M2 HMG (Raised)", "I_G_HMG_02_high_F", 2000], //Green
	["M2 HMG (Sighted)", "I_HMG_02_F", 2500], //Green
	["M2 HMG (Raised/Sighted)", "I_HMG_02_high_F", 2500], //Green
...
[
	["RGN Grenade", "MiniGrenade", 70],
	["RGO Grenade", "HandGrenade", 100],
	...
	["APERS Mine Dispenser", "APERSMineDispenser_Mag", 10001], //14 Mines
	["M6 SLAM Mine", "SLAMDirectionalMine_Wire_Mag", 500],
	["AT Mine", "ATMine_Range_Mag", 500],
    ["Training Mine", "TrainingMine_01_F", 35],
	...
	["Smoke Grenade (Yellow) Teargas", "SmokeShellYellow", 250],
...
[
	//Pistol and SMG
	["9x21mm 10Rnd Mag", "10Rnd_9x21_Mag", 2],
	["9x21mm 16Rnd Mag", "16Rnd_9x21_Mag", 15],
	["9x21mm 16Rnd R.Tracer Mag", "16Rnd_9x21_red_Mag", 15],
	["9x21mm 30Rnd Mag", "30Rnd_9x21_Mag", 25],
    ["9x21mm 30Rnd R.Tracer Mag", "30Rnd_9x21_Red_Mag", 25],
	["9x21mm 30Rnd Mag", "30Rnd_9x21_Mag_SMG_02", 25], //SMG
	["9x21mm 30Rnd R.Tracer Mag", "30Rnd_9x21_Mag_SMG_02_Tracer_Red", 25], //SMG
	[".45 ACP 6Rnd Cylinder", "6Rnd_45ACP_Cylinder", 10],
	[".45 ACP 9Rnd Mag", "9Rnd_45ACP_Mag", 15],
	[".45 ACP 11Rnd Mag", "11Rnd_45ACP_Mag", 25],
	[".45 ACP 30Rnd Mag", "30Rnd_45ACP_MAG_SMG_01", 25],
	[".45 ACP 30Rnd R.Tracer Mag", "30Rnd_45ACP_Mag_SMG_01_Tracer_Red", 25],
	//5.45 AKS
	...
	//5.56
	["5.56x45mm 20Rnd Underwater Mag", "20Rnd_556x45_UW_mag", 30],
	["5.56x45mm 30Rnd R.Tracer (Yellow) Mag", "30Rnd_556x45_Stanag", 25],
	["5.56x45mm 30Rnd Tracer (Yellow) Mag", "30Rnd_556x45_Stanag_Tracer_Yellow", 25],
	["5.56x45mm 30Rnd R.Tracer (Green) Mag", "30Rnd_556x45_Stanag_green", 25],
	["5.56x45mm 30Rnd Tracer (Green) Mag", "30Rnd_556x45_Stanag_Tracer_Green", 25],
	["5.56x45mm 30Rnd R.Tracer (Red) Mag", "30Rnd_556x45_Stanag_red", 25],
	["5.56x45mm 30Rnd Tracer (Red) Mag", "30Rnd_556x45_Stanag_Tracer_Red", 25],
	["5.56x45mm 30Rnd R.Tracer (Yellow) Mag (Sand)", "30Rnd_556x45_Stanag_Sand", 25],
	["5.56x45mm 30Rnd Tracer (Yellow) Mag (Sand)", "30Rnd_556x45_Stanag_Sand_Tracer_Yellow", 25],
	["5.56x45mm 30Rnd R.Tracer (Green) Mag (Sand)", "30Rnd_556x45_Stanag_Sand_green", 25],
	["5.56x45mm 30Rnd Tracer (Green) Mag (Sand)", "30Rnd_556x45_Stanag_Sand_Tracer_Green", 25],
	["5.56x45mm 30Rnd R.Tracer (Red) Mag (Sand)", "30Rnd_556x45_Stanag_Sand_red", 25],
	["5.56x45mm 30Rnd Tracer (Red) Mag (Sand)", "30Rnd_556x45_Stanag_Sand_Tracer_Red", 25],
    ["5.56x45mm 150Rnd Drum", "150Rnd_556x45_Drum_Mag_F", 100],
	["5.56x45mm 150Rnd Tracer Drum", "150Rnd_556x45_Drum_Mag_Tracer_F", 100],
	["5.56x45mm 150Rnd Drum (Khaki)", "150Rnd_556x45_Drum_Green_Mag_F", 100],
	["5.56x45mm 150Rnd Tracer Drum (Khaki)", "150Rnd_556x45_Drum_Green_Mag_Tracer_F", 100],
	["5.56x45mm 150Rnd Drum (Sand)", "150Rnd_556x45_Drum_Sand_Mag_F", 100],
	["5.56x45mm 150Rnd Tracer Drum (Sand)", "150Rnd_556x45_Drum_Sand_Mag_Tracer_F", 100],
	["5.56x45mm 200Rnd (Yellow) Belt", "200Rnd_556x45_Box_F", 130],
	["5.56x45mm 200Rnd Tracer (Yellow) Belt", "200Rnd_556x45_Box_Tracer_F", 130],
	["5.56x45mm 200Rnd (Red) Belt", "200Rnd_556x45_Box_Red_F", 130],
	["5.56x45mm 200Rnd Tracer (Red) Belt", "200Rnd_556x45_Box_Tracer_Red_F", 130],
	//5.7mm ADR-97
	["5.7x28mm 50Rnd Mag", "50Rnd_570x28_SMG_03", 20],
	//5.8mm
	["5.8x42mm 30Rnd Mag", "30Rnd_580x42_Mag_F", 30],
	["5.8x42mm 30Rnd Tracer Mag", "30Rnd_580x42_Mag_Tracer_F", 30],
	["5.8x42mm 100Rnd Drum", "100Rnd_580x42_Mag_F", 100],
	["5.8x42mm 100Rnd Tracer Drum", "100Rnd_580x42_Mag_Tracer_F", 100],
	["5.8x42mm 100Rnd Drum (Tropic Hex)", "100Rnd_580x42_ghex_Mag_F", 100],
	["5.8x42mm 100Rnd Tracer Drum (Tropic Hex)", "100Rnd_580x42_ghex_Mag_Tracer_F", 100],
	["5.8x42mm 100Rnd Drum (Arid Hex)", "100Rnd_580x42_hex_Mag_F", 100],
	["5.8x42mm 100Rnd Tracer Drum (Arid Hex)", "100Rnd_580x42_hex_Mag_Tracer_F", 100],
	//6.5mm
	//CMR-76
	["6.5x39mm 20Rnd Mag", "20Rnd_650x39_Cased_Mag_F", 25],
	//Katiba/Type 115
	["6.5x39mm 30Rnd Mag", "30Rnd_65x39_caseless_green", 30],
	["6.5x39mm 30Rnd Tracer Mag", "30Rnd_65x39_caseless_green_mag_Tracer", 30],
	//Promet
	["6.5x39mm 30Rnd Mag", "30Rnd_65x39_caseless_msbs_mag", 30],
	["6.5x39mm 30Rnd Tracer Mag", "30Rnd_65x39_caseless_msbs_mag_Tracer", 30],
	//MX
	["6.5x39mm 30Rnd Mag (Black)", "30Rnd_65x39_caseless_black_mag", 30],
	["6.5x39mm 30Rnd Tracer Mag (Black)", "30Rnd_65x39_caseless_black_mag_Tracer", 30],
	["6.5x39mm 30Rnd Mag (Sand)", "30Rnd_65x39_caseless_mag", 30],
	["6.5x39mm 30Rnd Tracer Mag (Sand)", "30Rnd_65x39_caseless_mag_Tracer", 30],
	["6.5x39mm 30Rnd Mag (Khaki)", "30Rnd_65x39_caseless_khaki_mag", 30],
	["6.5x39mm 30Rnd Tracer Mag (Khaki)", "30Rnd_65x39_caseless_khaki_mag_Tracer", 30],
	["6.5x39mm 100Rnd Mag (Black)", "100Rnd_65x39_caseless_black_mag", 150],
	["6.5x39mm 100Rnd Tracer Mag (Black)", "100Rnd_65x39_caseless_black_mag_tracer", 150],
	["6.5x39mm 100Rnd Mag (Sand)", "100Rnd_65x39_caseless_mag", 150],
	["6.5x39mm 100Rnd Tracer Mag (Sand)", "100Rnd_65x39_caseless_mag_Tracer", 150],
	["6.5x39mm 100Rnd Mag (Khaki)", "100Rnd_65x39_caseless_khaki_mag", 150],
	["6.5x39mm 100Rnd Tracer Mag (Khaki)", "100Rnd_65x39_caseless_khaki_mag_tracer", 150],
	//Mk200
	["6.5x39mm 200Rnd (Yellow) Belt", "200Rnd_65x39_cased_Box", 225],
	["6.5x39mm 200Rnd Tracer (Yellow) Belt", "200Rnd_65x39_cased_Box_Tracer", 225],
	["6.5x39mm 200Rnd (Red) Belt", "200Rnd_65x39_cased_Box_Red", 225],
	["6.5x39mm 200Rnd Tracer (Red) Belt", "200Rnd_65x39_cased_Box_Tracer_Red", 225],
	//7.62
	["7.62x54mm 10Rnd Mag", "10Rnd_762x54_Mag", 50],
	["7.62x51mm 10Rnd Mag", "10Rnd_Mk14_762x51_Mag", 50],
	["7.62x51mm 20Rnd Mag", "20Rnd_762x51_Mag", 75],
	//AK-Series
    ["7.62x39mm 30Rnd AKM Mag", "30Rnd_762x39_Mag_F", 50],
	["7.62x39mm 30Rnd AKM Tracer (Yellow) Mag", "30Rnd_762x39_Mag_Tracer_F", 50],
	["7.62x39mm 30Rnd AKM Tracer (Green) Mag", "30Rnd_762x39_Mag_Tracer_Green_F", 50],
	["7.62x39mm 30Rnd AK12 Mag", "30Rnd_762x39_AK12_Mag_F", 50],
	["7.62x39mm 30Rnd AK12 Tracer Mag", "30Rnd_762x39_AK12_Mag_Tracer_F", 50],
	["7.62x39mm 30Rnd AK12 Mag (Arid)", "30rnd_762x39_AK12_Arid_Mag_F", 50],
	["7.62x39mm 30Rnd AK12 Tracer Mag (Arid)", "30rnd_762x39_AK12_Arid_Mag_Tracer_F", 50],
	["7.62x39mm 30Rnd AK12 Mag (Lush)", "30rnd_762x39_AK12_Lush_Mag_F", 50],
	["7.62x39mm 30Rnd AK12 Tracer Mag (Lush)", "30rnd_762x39_AK12_Lush_Mag_Tracer_F", 50],
	["7.62x39mm 75Rnd AKM Mag", "75rnd_762x39_Mag_F", 100],
	["7.62x39mm 75Rnd AKM Tracer Mag", "75Rnd_762x39_Mag_Tracer_F", 100],
	["7.62x39mm 75Rnd AK12 Drum", "75rnd_762x39_AK12_Mag_F", 100],
	["7.62x39mm 75Rnd AK12 Tracer Drum", "75rnd_762x39_AK12_Mag_Tracer_F", 100],
	["7.62x39mm 75Rnd AK12 Drum (Arid)", "75rnd_762x39_AK12_Arid_Mag_F", 100],
	["7.62x39mm 75Rnd AK12 Tracer Drum (Arid)", "75rnd_762x39_AK12_Arid_Mag_Tracer_F", 100],
	["7.62x39mm 75Rnd AK12 Drum (Lush)", "75rnd_762x39_AK12_Lush_Mag_F", 100],
	["7.62x39mm 75Rnd AK12 Tracer Drum (Lush)", "75rnd_762x39_AK12_Lush_Mag_Tracer_F", 100],
	//Zafir LMG
	["7.62x54mm 150Rnd Box", "150Rnd_762x54_Box", 250],
	["7.62x54mm 150Rnd Tracer Box", "150Rnd_762x54_Box_Tracer", 275],
	//Big Guns
	[".338 Lapua Magnum 10Rnd Mag", "10Rnd_338_Mag", 200],
	[".338 Norma Magnum 130Rnd Belt", "130Rnd_338_Mag", 500],
	["9.3x64mm 10Rnd Cyrus Mag", "10Rnd_93x64_DMR_05_Mag", 200],
	["9.3x64mm 150Rnd Navid Belt", "150Rnd_93x64_Mag", 500],
	[".408 7Rnd Cheetah Mag", "7Rnd_408_Mag", 500],
	["12.7x108mm 5Rnd Lynx Mag", "5Rnd_127x108_Mag", 500],
	["12.7x108mm 5Rnd Lynx AP Mag", "5Rnd_127x108_APDS_Mag", 700],
	["12.7x54mm 10Rnd Mag", "10Rnd_127x54_Mag", 400],
	["12.7x42mm 10Rnd Mag", "10Rnd_50BW_Mag_F", 500],
	//Shotgun
	...
	//Rockets and Missiles						              //                 hit                      hit,  radius
    ["PG-7VM HEAT Grenade", "RPG7_F", 250],                   // Direct damage:  343     | Splash damage:  13,  3.0m     | Guidance: none
    ["RPG-42 HEAT Rocket", "RPG32_F", 350],                   //                 422     |                 28,  2.5m     |           none
    ["RPG-42 HE Rocket", "RPG32_HE_F", 300],                  //                 200     |                 50,  6.0m     |           none
    ["MAAWS HEAT 75 Rocket", "MRAWS_HEAT_F", 350],            //                 495     |                 14,  2.0m     |           none
    ["MAAWS HEAT 55 Rocket", "MRAWS_HEAT55_F", 350],          //                 450     |                 14,  2.0m     |           none
    ["MAAWS HE 44 Rocket", "MRAWS_HE_F", 300],                //                 200     |                 50,  6.0m     |           none
    ...
    ["Titan AT Missile", "Titan_AT", 1000],                   //                 515     |                 20,  2.0m     |           mouse, laser/IR, hot ground vehicles
    ["Titan HE Missile", "Titan_AP", 750],                    //                 100     |                 25, 10.0m     |           mouse, laser/IR
    ["Titan AA Missile", "Titan_AA", 1000],                   //                  80     |                 60,  6.0m     |           aircraft
	["40mm HE Grenade", "1Rnd_HE_Grenade_shell", 300],
	["40mm 3Rnd HE Grenades", "3Rnd_HE_Grenade_shell", 900],
	["40mm Smoke (White)", "1Rnd_Smoke_Grenade_shell", 50],
	["40mm Smoke (Purple)", "1Rnd_SmokePurple_Grenade_shell", 50],
	["40mm Smoke (Blue)", "1Rnd_SmokeBlue_Grenade_shell", 50],
	["40mm Smoke (Green)", "1Rnd_SmokeGreen_Grenade_shell", 50],
	["40mm Smoke (Yellow) Teargas", "1Rnd_SmokeYellow_Grenade_shell", 300],
	["40mm Smoke (Orange)", "1Rnd_SmokeOrange_Grenade_shell", 50],
	["40mm Smoke (Red)", "1Rnd_SmokeRed_Grenade_shell", 50],
	...
	["40mm 3Rnd Smokes (Yellow) Teargas", "3Rnd_SmokeYellow_Grenade_shell", 900],
	["40mm 3Rnd Smokes (Orange)", "3Rnd_SmokeOrange_Grenade_shell", 150],
	["40mm 3Rnd Smokes (Red)", "3Rnd_SmokeRed_Grenade_shell", 150],
	["40mm Flare (White)", "UGL_FlareWhite_F", 25],
	["40mm Flare (Green)", "UGL_FlareGreen_F", 25],
	["40mm Flare (Yellow)", "UGL_FlareYellow_F", 25],
	["40mm Flare (Red)", "UGL_FlareRed_F", 25],
	["40mm Flare (IR)", "UGL_FlareCIR_F", 25],
	["40mm 3Rnd Flares (White)", "3Rnd_UGL_FlareWhite_F", 75],
	["40mm 3Rnd Flares (Green)", "3Rnd_UGL_FlareGreen_F", 75],
	["40mm 3Rnd Flares (Yellow)", "3Rnd_UGL_FlareYellow_F", 75],
	["40mm 3Rnd Flares (Red)", "3Rnd_UGL_FlareRed_F", 75],
	["40mm 3Rnd Flares (IR)", "3Rnd_UGL_FlareCIR_F", 75]
...
[
    ...
    ["Suppressor 5.56mm (Black)", "muzzle_snds_M", 300, "item"],
    ["Suppressor 5.56mm (Khaki)", "muzzle_snds_m_khk_F", 300, "item", "noDLC"],
    ["Suppressor 5.56mm (Sand)", "muzzle_snds_m_snd_F", 300, "item", "noDLC"],
	["Suppressor 5.7mm", "muzzle_snds_570", 200, "item"],
    ["Suppressor 5.8mm Stealth (Black)", "muzzle_snds_58_blk_F", 300, "item"],
	["Suppressor 5.8mm Stealth (Green Hex)", "muzzle_snds_58_ghex_F", 300, "item"],
	["Suppressor 5.8mm Stealth (Hex)", "muzzle_snds_58_hex_F", 300, "item"],
    ["Suppressor 6.5mm (Black)", "muzzle_snds_H", 350, "item"],
    ["Suppressor 6.5mm (Khaki)", "muzzle_snds_H_khk_F", 350, "item", "noDLC"],
    ["Suppressor 6.5mm (Sand)", "muzzle_snds_H_snd_F", 350, "item", "noDLC"],
    ["Suppressor 6.5mm Mk200 (Black)", "muzzle_snds_H_MG_blk_F", 350, "item", "noDLC"],
    ["Suppressor 6.5mm Mk200 (Khaki)", "muzzle_snds_H_MG_khk_F", 350, "item", "noDLC"],
    ["Suppressor 6.5mm Mk200 (Sand)", "muzzle_snds_H_MG", 350, "item"],
    ["Suppressor 6.5mm Stealth (Black)", "muzzle_snds_65_TI_blk_F", 350, "item"],
    ["Suppressor 6.5mm Stealth (Green Hex)", "muzzle_snds_65_TI_ghex_F", 350, "item"],
    ["Suppressor 6.5mm Stealth (Hex)", "muzzle_snds_65_TI_hex_F", 350, "item"],
    ["Suppressor 7.62mm (Black)", "muzzle_snds_B", 500, "item"],
    ["Suppressor 7.62mm (Khaki)", "muzzle_snds_B_khk_F", 500, "item", "noDLC"],
    ["Suppressor 7.62mm (Sand)", "muzzle_snds_B_snd_F", 500, "item", "noDLC"],
	["Suppressor 7.62mm (Arid)", "muzzle_snds_B_arid_F", 500, "item", "noDLC"],
	["Suppressor 7.62mm (Lush)", "muzzle_snds_B_lush_F", 500, "item", "noDLC"],
	["Suppressor .338 (Black)", "muzzle_snds_338_black", 500, "item"],
	["Suppressor .338 (Green)", "muzzle_snds_338_green", 500, "item"],
	["Suppressor .338 (Sand)", "muzzle_snds_338_sand", 500, "item"],
	["Suppressor 9.3mm (Black)", "muzzle_snds_93mmg", 500, "item"],
	["Suppressor 9.3mm (Tan)", "muzzle_snds_93mmg_tan", 500, "item"],
	["Bipod (Black) (NATO)", "bipod_01_F_blk", 25, "item", "noDLC"],
	["Bipod (Black) (CSAT)", "bipod_02_F_blk", 25, "item", "noDLC"],
	["Bipod (Black) (AAF)", "bipod_03_F_blk", 25, "item", "noDLC"],
	["Bipod (MTP)", "bipod_01_F_mtp", 25, "item", "noDLC"],
	["Bipod (Hex)", "bipod_02_F_hex", 25, "item", "noDLC"],
	["Bipod (Olive)", "bipod_03_F_oli", 25, "item", "noDLC"],
	["Bipod (Sand)", "bipod_01_F_snd", 25, "item", "noDLC"],
	["Bipod (Tan)", "bipod_02_F_tan", 25, "item", "noDLC"],
    ["Bipod (Khaki)", "bipod_01_F_khk", 25, "item", "noDLC"],
	["Bipod (Arid)", "bipod_02_F_arid", 25, "item", "noDLC"],
	["Bipod (Lush)", "bipod_02_F_lush", 25, "item", "noDLC"],
	["Flashlight", "acc_flashlight", 5, "item"],
    ["Pistol Flashlight" ,"acc_flashlight_pistol", 5, "item"],
	["IR Laser Pointer", "acc_pointer_IR", 25, "item"],
    ["MRD (4-five/Sand)", "optic_MRD", 25, "item"],
    ["MRD (4-five/Black)", "optic_MRD_black", 25, "item", "noDLC"],
	["Yorris J2", "optic_Yorris", 25, "item"],
	["ACO (Red)", "optic_Aco", 150, "item"],
    ["ACO SMG (Red)", "optic_aco_smg", 100, "item"],
	["ACO (Green)", "optic_Aco_grn", 150, "item"],
    ["ACO SMG (Green)", "optic_ACO_grn_smg", 100, "item"],
    ["Holosight", "optic_Holosight", 150, "item"],
	["Holosight SMG", "optic_Holosight_smg", 100, "item"],
    ["Holosight (Black)", "optic_Holosight_blk_F", 150, "item", "noDLC"],
	["Holosight SMG (Black)", "optic_Holosight_smg_blk_F", 100, "item"],
    ["Holosight (Khaki)", "optic_Holosight_khk_F", 150, "item", "noDLC"],
	["Holosight SMG (Khaki)", "optic_Holosight_smg_khk_F", 100, "item"],
	["Holosight (Arid)", "optic_Holosight_arid_F", 150, "item"],
	["Holosight (Lush)", "optic_Holosight_lush_F", 150, "item"],
    ["Promet Modular Sight (Green)", "optic_ico_01_f", 100, "item"],
    ...
    ["MRCO", "optic_MRCO", 450, "item"],
    ["ARCO", "optic_Arco", 700, "item"],
    ["ARCO (Black)", "optic_Arco_blk_F", 700, "item", "noDLC"],
    ["ARCO (Green Hex)", "optic_Arco_ghex_F", 700, "item", "noDLC"],
	["ARCO (Arid)", "optic_Arco_arid_F", 700, "item", "noDLC"],
	["ARCO (Lush)", "optic_Arco_lush_F", 700, "item", "noDLC"],
	["ARCO AK (Arid)", "optic_Arco_AK_arid_F", 700, "item", "noDLC"],
	["ARCO AK (Black)", "optic_Arco_AK_blk_F", 700, "item", "noDLC"],
	["ARCO AK (Lush)", "optic_Arco_AK_lush_F", 700, "item", "noDLC"],
    ["RCO", "optic_Hamr", 700, "item"],
    ["RCO (Khaki)", "optic_Hamr_khk_F", 700, "item", "noDLC"],
    ["ERCO (Black)", "optic_ERCO_blk_F", 700, "item"],
    ["ERCO (Green)", "optic_ERCO_khk_F", 700, "item"],
    ["ERCO (Sand)", "optic_ERCO_snd_F", 700, "item"],
    ["MOS", "optic_SOS", 700, "item"],
    ["MOS (Khaki)", "optic_SOS_khk_F", 700, "item", "noDLC"],
    ["DMS", "optic_DMS", 950, "item"],
    ["DMS (Green Hex)","optic_DMS_ghex_F", 950, "item"],
	["DMS (Old)","optic_DMS_weathered_F", 950, "item"],
	["DMS Kir (Old)","optic_DMS_weathered_Kir_F", 950, "item"],
	["AMS", "optic_AMS", 1000, "item"],
	["AMS (Khaki)", "optic_AMS_khk", 1000, "item"],
	["AMS (Sand)", "optic_AMS_snd", 1000, "item"],
    ["Kahlia (Sightless)", "optic_KHS_old", 650, "item"],
	["Kahlia (Black)", "optic_KHS_blk", 700, "item"],
...
[
	...
	["Stealth Combat Helmet (Arid)", "H_HelmetB_TI_arid_F", 350, "hat"],
	...
	["Enhanced Combat Helmet (Light)", "H_HelmetB_light", 150, "hat"],
	["Enhanced Combat Helmet (Light, Sand)", "H_HelmetB_light_sand", 150, "hat"],
	["Enhanced Combat Helmet (Light, Black)", "H_HelmetB_light_black", 150, "hat"],
	["Enhanced Combat Helmet (Light, Desert)", "H_HelmetB_light_desert", 150, "hat"],
	["Enhanced Combat Helmet (Light, Snakeskin)", "H_HelmetB_light_snakeskin", 150, "hat"],
	["Enhanced Combat Helmet (Light, Grass)", "H_HelmetB_light_grass", 150, "hat"],
	["Enhanced Combat Helmet (Light, Tropic)", "H_HelmetB_Light_tna_F", 150, "hat"],
	["Enhanced Combat Helmet (Light, Woodland)", "H_HelmetB_light_wdl", 150, "hat"],
	...
	["Modular Helmet", "H_HelmetIA", 150, "hat"],
	...
	["Beret (CSAT)", "H_Beret_CSAT_01_F", 10, "hat"],
	...
	["Parade Cap [AAF]", "H_ParadeDressCap_01_AAF_F", 100, "hat"],
	["Parade Cap [CSAT]", "H_ParadeDressCap_01_CSAT_F", 100, "hat"],
	["Parade Cap [NATO]", "H_ParadeDressCap_01_US_F", 100, "hat"],
	["Parade Cap [LDF]", "H_ParadeDressCap_01_LDF_F", 100, "hat"]
...
[
	...
	["Combat Fatigues Recon (MTP)", "U_B_CombatUniform_mcam_vest", 100, "uni"],
	["Combat Fatigues Worn (MTP)", "U_I_G_Story_Protagonist_F", 90, "uni"],
    ["Combat Fatigues (Tropic)", "U_B_T_Soldier_F", 100, "uni"],
	["Combat Fatigues Shirt (Tropic)", "U_B_T_Soldier_AR_F", 100, "uni"],
	["Combat Fatigues Recon (Tropic)", "U_B_T_Soldier_SL_F", 100, "uni", "noDLC"],
	// ["Recon Fatigues (Sage)", "U_B_SpecopsUniform_sgg", 100, "uni"],					//Duplicate...
	["Combat Fatigues (Woodland)", "U_B_CombatUniform_mcam_wdl_f", 100, "uni", "noDLC"],
	["Combat Fatigues Shirt (Woodland)", "U_B_CombatUniform_tshirt_mcam_wdL_f", 100, "uni", "noDLC"],
    ["Combat Fatigues Recon (Woodland)", "U_B_CombatUniform_vest_mcam_wdl_f", 100, "uni", "noDLC"],
    ...
    ["Combat Fatigues Recon (AAF, Digi)", "U_I_CombatUniform_shortsleeve", 100, "uni"],      //Independent
	["Combat Fatigues Officer (AAF, Digi)", "U_I_OfficerUniform", 105, "uni"],
	["Combat Fatigues (LDF, Woodland)", "U_I_E_Uniform_01_F", 100, "uni"],
	["Combat Fatigues Recon (LDF, Woodland)", "U_I_E_Uniform_01_shortsleeve_F", 100, "uni"],
	["Combat Fatigues Officer (LDF, Woodland)", "U_I_E_Uniform_01_officer_F", 100, "uni"],
	["Combat Fatigues Sweater (LDF, Woodland)", "U_I_E_Uniform_01_sweater_F", 100, "uni"],
	["Combat Fatigues Tank Top (LDF, Woodland)", "U_I_E_Uniform_01_tanktop_F", 100, "uni"],

    ["Combat Fatigues (Stavrou)", "U_I_G_resistanceLeader_F", 100, "uni"],

    ["CTRG Combat Uniform (Arid)", "U_B_CTRG_1", 100, "uni"],
	["CTRG Combat Uniform Recon (Arid)", "U_B_CTRG_2", 100, "uni"],
	["CTRG Combat Uniform Shirt (Arid)", "U_B_CTRG_3", 100, "uni"],
	["CTRG Combat Uniform (Urban)", "U_B_CTRG_Soldier_urb_1_F", 100, "uni"],
    ["CTRG Combat Uniform Recon (Urban)", "U_B_CTRG_Soldier_urb_3_F", 100, "uni"],
    ["CTRG Combat Uniform Shirt (Urban)", "U_B_CTRG_Soldier_urb_2_F", 100, "uni"],

	["CTRG Stealth Uniform (Arid)", "U_B_CTRG_Soldier_Arid_F", 100, "uni"],				//Increase Price to 1000 if Thermal active
	["CTRG Stealth Uniform Recon (Arid)", "U_B_CTRG_Soldier_3_Arid_F", 100, "uni"],		//Increase Price to 1000 if Thermal active
	["CTRG Stealth Uniform Shirt (Arid)", "U_B_CTRG_Soldier_2_Arid_F", 100, "uni"],		//Increase Price to 1000 if Thermal active
    ["CTRG Stealth Uniform (Tropic)", "U_B_CTRG_Soldier_F", 100, "uni"],				//Increase Price to 1000 if Thermal active
    ["CTRG Stealth Uniform Recon (Tropic)", "U_B_CTRG_Soldier_3_F", 100, "uni"],		//Increase Price to 1000 if Thermal active
    ["CTRG Stealth Uniform Shirt (Tropic)", "U_B_CTRG_Soldier_2_F", 100, "uni"],		//Increase Price to 1000 if Thermal active
	...
	["Spetsnaz Combat Uniform (Granit-B)", "U_O_R_Gorka_01_F", 100, "uni"],
	["Spetsnaz Combat Uniform Worn (Granit-B)", "U_O_R_Gorka_01_brown_F", 95, "uni"],
	["Spetsnaz Combat Uniform (Granit-T)", "U_O_R_Gorka_01_camo_F", 100, "uni"],
	...
	["Heli Pilot Coveralls (AAF, Digi)", "U_I_HeliPilotCoveralls", 100, "uni"],
	["Heli Pilot Coveralls (LDF, Woodland)", "U_I_E_Uniform_01_coveralls_F", 100, "uni"],
	...
	["CBRN Suit (Blue)", "U_C_CBRN_Suit_01_Blue_F", 100, "uni"],
	["CBRN Suit (White)", "U_C_CBRN_Suit_01_White_F", 100, "uni"],

	["Parade Uniform Decorated [AAF]", "U_I_ParadeUniform_01_AAF_decorated_F", 100, "uni"],
	["Parade Uniform Decorated [CSAT]", "U_O_ParadeUniform_01_CSAT_decorated_F", 100, "uni"],
	["Parade Uniform Decorated [NATO]", "U_B_ParadeUniform_01_US_decorated_F", 100, "uni"],
	["Parade Uniform Decorated [LDF]", "U_I_E_ParadeUniform_01_LDF_decorated_F", 100, "uni"],

	["Parade Uniform [AAF]", "U_I_ParadeUniform_01_AAF_F", 100, "uni"],
	["Parade Uniform [CSAT]", "U_O_ParadeUniform_01_CSAT_F", 100, "uni"],
	["Parade Uniform [NATO]", "U_B_ParadeUniform_01_US_F", 100, "uni"],
	["Parade Uniform [LDF]", "U_I_E_ParadeUniform_01_LDF_F", 100, "uni"]
...
[
    ...
    ["Safety Vest (Yellow)", "V_Safety_yellow_F", 5, "vest", "noDLC"],
    ["Safety Vest (Orange)", "V_Safety_orange_F", 5, "vest", "noDLC"],
    ["Safety Vest (Blue)", "V_Safety_blue_F", 5, "vest", "noDLC"],
    ["Identification Vest (Medic)", "V_Plain_crystal_F", 5, "vest", "noDLC"],
    ["Identification Vest (IDAP)", "V_Plain_medical_F", 5, "vest", "noDLC"],
    ...
    ["Tactical Vest (Stavrou)", "V_I_G_resistanceLeader_F", 250, "vest"],
	...
	["Carrier Lite (Green, US Flag)", "V_PlateCarrier1_rgr", 500, "vest"],
	["Carrier Lite (Green, no Flag)", "V_PlateCarrier1_rgr_noflag_F", 500, "vest"],
	["Carrier Lite (Black, no Flag)", "V_PlateCarrier1_blk", 500, "vest"],
	["Carrier Lite (CTRG, UK Flag)", "V_PlateCarrierL_CTRG", 500, "vest"],
    ["Carrier Lite (Tropic, US Flag)", "V_PlateCarrier1_tna_F", 500, "vest", "noDLC"],
    ["Carrier Lite (Woodland, US Flag)", "V_PlateCarrier1_wdl", 500, "vest", "noDLC"],
    ["GA Carrier Lite (Digi)", "V_PlateCarrierIA1_dgtl", 500, "vest"],
    ...
    ["Carrier Rig (Woodland, US Flag)", "V_PlateCarrier2_wdl", 1000, "vest"],
	["Carrier Special Rig (Green)", "V_PlateCarrierSpec_rgr", 6500, "vest"],
	["Carrier Special Rig (Black)", "V_PlateCarrierSpec_blk", 6500, "vest"],
	["Carrier Special Rig (MTP)", "V_PlateCarrierSpec_mtp", 6500, "vest"],
    ["Carrier Special Rig (Tropic)", "V_PlateCarrierSpec_tna_F", 6500, "vest"],
	["Carrier Special Rig (Woodland)", "V_PlateCarrierSpec_wdl", 6500, "vest"],
    ...
    ["Carrier GL Rig (Woodland)", "V_PlateCarrierGL_wdl", 2500, "vest"],
    ["GA Carrier GL Rig (Digi)", "V_PlateCarrierIAGL_dgtl", 2500, "vest"],
	["GA Carrier GL Rig (Olive)", "V_PlateCarrierIAGL_oli", 2500, "vest"],
    ["Modular Carrier GL Rig (Geometric)", "V_CarrierRigKBT_01_heavy_EAF_F", 2500, "vest"],
    ["Modular Carrier GL Rig (Olive)", "V_CarrierRigKBT_01_heavy_Olive_F", 2500, "vest"],
    ["EOD Vest (Blue)", "V_EOD_blue_F", 2500, "vest"],
    ["EOD Vest (Blue, IDAP)", "V_EOD_IDAP_blue_F", 2500, "vest"],
    ["EOD Vest (Coyote)", "V_EOD_coyote_F", 2500, "vest"],
    ["EOD Vest (Olive)", "V_EOD_olive_F", 2500, "vest"]
];
...
[
	...
	["Kitbag (Tan)", "B_Kitbag_tan", 200, "backpack"],
...
[
	...
	["IR Grenade (NATO)", "B_IR_Grenade", 20, "mag"],
	["IR Grenade (CSAT)", "O_IR_Grenade", 20, "mag"],
	["IR Grenade (AAF)", "I_IR_Grenade", 20, "mag"],
	["Chemlight (Blue)", "Chemlight_blue", 20, "mag"],
	["Chemlight (Green)", "Chemlight_green", 20, "mag"],
	["Chemlight (Yellow)", "Chemlight_yellow", 20, "mag"],
	["Chemlight (Red)", "Chemlight_red", 20, "mag"],
    ...
    ["Compact NVG (CSAT, Green Hex)", "O_NVGoggles_ghex_F", 500, "nvg", "noDLC"],
    ["Compact NVG (CSAT, Hex)", "O_NVGoggles_hex_F", 500, "nvg", "noDLC"],
    ["Compact NVG (CSAT, Urban)", "O_NVGoggles_urb_F", 500, "nvg", "noDLC"],
    ["Compact NVG (Green)", "O_NVGoggles_grn_F", 500, "nvg", "noDLC"],
    ["ENVG-II (NATO, Black)", "NVGogglesB_blk_F", 500, "nvg"],         // With Termal
    ["ENVG-II (NATO, Green)", "NVGogglesB_grn_F", 500, "nvg"],         // With Termal
    ["ENVG-II (NATO, Grey)", "NVGogglesB_gry_F", 500, "nvg"],          // With Termal
	["APR (Black) [Teargas]", "G_AirPurifyingRespirator_02_black_F", 500, "gogg", "noDLC"],
	["APR (Olive) [Teargas]", "G_AirPurifyingRespirator_02_olive_F", 500, "gogg", "noDLC"],
	["APR (Sand) [Teargas]", "G_AirPurifyingRespirator_02_sand_F", 500, "gogg", "noDLC"],
	["APR (NATO) [Teargas]", "G_AirPurifyingRespirator_01_F", 500, "gogg", "noDLC"],
	["Regular Facepiece [Teargas]", "G_RegulatorMask_F", 500, "gogg", "noDLC"],
	["Bandanna (Aviator)", "G_Bandanna_aviator", 5, "gogg"],
	["Bandanna (Shades)", "G_Bandanna_shades", 5, "gogg"],
	["Bandanna (Beast)", "G_Bandanna_beast", 100, "gogg"],
	["Bandanna (Black)", "G_Bandanna_blk", 5, "gogg"],
	["Bandanna (Khaki)", "G_Bandanna_khk", 5, "gogg"],
	["Bandanna (Olive)", "G_Bandanna_oli", 5, "gogg"],
	["Bandanna (Tan)", "G_Bandanna_tan", 5, "gogg"],
    ["Aviator Googles", "G_Aviator", 5, "gogg"],
	["Balaclava (Black)", "G_Balaclava_blk", 5, "gogg"],
	["Balaclava (Olive)", "G_Balaclava_oli", 5, "gogg"],
	["Balaclava (Low Profile G)", "G_Balaclava_lowprofile", 5, "gogg"],
	["Balaclava (Combat)", "G_Balaclava_combat", 5, "gogg"],
    ["Stealth Balaclava (Black)", "G_Balaclava_TI_blk_F", 5, "gogg"],
    ["Stealth Balaclava w. Googles (Black)", "G_Balaclava_TI_G_blk_F", 5, "gogg"],
    ["Stealth Balaclava (Green)", "G_Balaclava_TI_tna_F", 5, "gogg"],
    ["Stealth Balaclava w. Goggles (Green)", "G_Balaclava_TI_G_tna_F", 5, "gogg"],
    ["Lady Shades", "G_Lady_Blue", 5, "gogg"],
    ["Low Profile Googles", "G_Lowprofile", 5, "gogg"],
    ["Tactical Googles", "G_Tactical_Clear", 5, "gogg"],
    ["Tactical Shades", "G_Tactical_Black", 5, "gogg"],
    ["Ray Ban", "G_Spectacles_Tinted", 5, "gogg"],
	["Diving Goggles", "G_Diving", 100, "gogg"],
    ["Combat Goggles (Tan)", "G_Combat", 5, "gogg"],
    ["Combat Goggles (Green)", "G_Combat_Goggles_tna_F", 5, "gogg", "noDLC"],
    ["Respirator (Blue)", "G_Respirator_blue_F", 10, "gogg"],
    ["Bandanna (White)", "G_Respirator_white_F", 10, "gogg"],
    ["Bandanna (Yellow)", "G_Respirator_yellow_F", 10, "gogg"],
    ["Safety Goggles", "G_EyeProtectors_F", 5, "gogg"],
    ["Safety Goggles (Earpiece)", "G_EyeProtectors_Earpiece_F", 5, "gogg"],
    ["Wireless Earpiece", "G_WirelessEarpiece_F", 5, "gogg"],
	["Blindfold (Black)", "G_Blindfold_01_black_F", 5, "gogg", "noDLC"],
	["Blindfold (White)", "G_Blindfold_01_white_F", 5, "gogg", "noDLC"]
...
[
	...
	["Empty Supply Crate", "I_supplyCrate_F", 1000, "ammocrate"],
	...
	// ["Woman Statue", "Land_Statue_03_F", 1000, "object"],
	...
	["Pop-Up Target Infantry", "TargetP_Inf_F", 100, "object"],
	// ["Pop-Up Target HVT", "TargetP_HVT1_F", 100, "object"],
	// ["Pop-Up Target Alien", "TargetP_Alien1_Acc1_F", 100, "object"],
    ...
    ["Concrete Block", "BlockConcrete_F", 400, "object"],
		["Concrete Railway Platform Large", "Land_Rail_ConcreteRamp_F", 500],			//new 1
		["Cobblestone Platform Large", "Land_CobblestoneSquare_01_32m_F", 500],		//new 2
...
[
	...
	["Qilin AT", "O_T_LSV_02_AT_F", 9500, "vehicle"],
...
[
    ...
    ["AH-9 Pawnee (Gun-Only)", "B_Heli_Light_01_dynamicLoadout_F", 18999, "vehicle", "variant_pawneeGun"], // Armed AH-6 (no missiles)
	...
	["WY-55 Hellcat (Gun-Only)", "I_Heli_light_03_dynamicLoadout_F", 25000, "vehicle", "variant_HellcatGun"], // Armed Hellcat (no missiles)
    ["WY-55 Hellcat (Armed)", "I_Heli_light_03_dynamicLoadout_F", 65000, "vehicle", "variant_hellcatNormal"], // Armed Hellcat
    ["AH-99 Blackfoot", "B_Heli_Attack_01_dynamicLoadout_F", 95000, "vehicle"], // RAH-66 with gunner
	["Mi-48 Kajman (Gun-Only)", "O_Heli_Attack_02_dynamicLoadout_F", 45001, "vehicle", "variant_KajmanGunOnly"],
    ["Mi-48 Kajman", "O_Heli_Attack_02_dynamicLoadout_F", 90000, "vehicle", "variant_KajmanNormal"], // Mi-28 with gunner
...
[
    ...
    ["A-143 Buzzard CAS", "I_Plane_Fighter_03_dynamicLoadout_F", 85000, "vehicle", "variant_buzzardCAS"],
    ["A-149 Gryphon", "I_Plane_Fighter_04_F", 95000, "vehicle"],
	["A-149 Gryphon (Bomber)", "I_Plane_Fighter_04_F", 95000, "vehicle", "variant_GryphonBomb"],
	["A-149 Gryphon (CAS)", "I_Plane_Fighter_04_F", 95000, "vehicle", "variant_GryphonCAS"],
	["A-149 Gryphon (AA)", "I_Plane_Fighter_04_F", 105000, "vehicle", "variant_GryphonAA"],
    ["F/A-181 Black Wasp", "B_Plane_Fighter_01_F", 115000, "vehicle"],
	["F/A-181 Black Wasp (CAS)", "B_Plane_Fighter_01_F", 115000, "vehicle", "variant_WaspCAS"],
	//["F/A-181 Black Wasp (AA)", "B_Plane_Fighter_01_F", 80000, "vehicle", "variant_WaspAA"],
    ["F/A-181 Black Wasp Stealth", "B_Plane_Fighter_01_Stealth_F", 110000, "vehicle"],
    ["To-201 Shikra", "O_Plane_Fighter_02_F", 120000, "vehicle"],
	["To-201 Shikra (CAS)", "O_Plane_Fighter_02_F", 120000, "vehicle", "variant_ShikraCAS"],
	//["To-201 Shikra (AA)", "O_Plane_Fighter_02_F", 120000, "vehicle", "variant_ShikraAA"],
    ["To-201 Shikra Stealth", "O_Plane_Fighter_02_Stealth_F", 120000, "vehicle"],

    ["A-164 Wipeout CAS", "B_Plane_CAS_01_dynamicLoadout_F", 125000, "vehicle"],
    ["To-199 Neophron CAS", "O_Plane_CAS_02_dynamicLoadout_F", 120000, "vehicle"],
...
[
	...
	["Energy Drink", "energydrink", localize "STR_WL_ShopDescriptions_Energy_Drink", "client\icons\energydrink.paa", 1000, 500]
